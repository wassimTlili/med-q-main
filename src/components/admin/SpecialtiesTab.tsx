    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-6 justify-between">
        <div className="flex-1">
          <h3 className="text-2xl font-bold text-foreground mb-2">{t('admin.manageSpecialties')}</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-11 pr-11 w-full sm:w-80 h-11 rounded-xl border-border focus:border-purple-500 focus:ring-purple-500 bg-background shadow-sm"
            />
            {searchQuery && (
              <Button
                variant="ghost"
          ...
          <Button 
            ...
            className="h-11 px-6 bg-purple-600 hover:bg-purple-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {isLoading ? (
          Array(6).fill(0).map((_, i) => (
            <div key={i} className="border-0 shadow-lg bg-card rounded-2xl p-6 animate-pulse">
          ...
          <div className="col-span-full flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border p-12 text-center bg-card">
            {searchQuery ? (
              <>
              ...
              <>
                <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <PlusCircle className="w-8 h-8 text-blue-500" />
                </div>
                <h3 className="text-xl font-bold text-foreground mb-2">{t('admin.noSpecialtiesAvailable')}</h3>
