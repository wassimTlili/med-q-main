      ...
      <div className="relative overflow-hidden backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border border-gray-200/60 dark:border-gray-700/60 rounded-2xl shadow-lg">
        ...
        <div className="relative z-10 p-8">
          <div className="flex items-center gap-6 mb-6">
            ...
            {/* Medical Icon */}
            <div className={`flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 border border-gray-200 dark:border-gray-600 shadow-md ${medicalIcon.color} ${medicalIcon.darkColor}`}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-2">
                ...
                {specialty.niveau && (
                  <span className="px-3 py-1 text-sm font-medium bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded-full border border-purple-200 dark:border-purple-700">
          ...
          {specialty.progress && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="text-center p-4 bg-gray-50/50 dark:bg-gray-700/30 rounded-xl border border-gray-200/50 dark:border-gray-600/50">
