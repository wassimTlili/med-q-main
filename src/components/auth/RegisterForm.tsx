...
import { EyeIcon, EyeOffIcon, Loader2, Facebook, Eye, EyeOff } from 'lucide-react';
...
export function RegisterForm({ onToggleForm }: { onToggleForm: () => void }) {
  ...
  const handleFacebookSignUp = async () => {
    ...
    try {
      ...
      setError('Facebook authentication is not properly configured. Please try again later.');
      stopFacebookLoading();
    }
  };
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl font-semibold text-gray-800 mb-8">Inscription</h2>
      ...
      <form onSubmit={handleRegister} className="space-y-6">
        ...
        <div>
          ...
          >
            ...
            <option value="veterinaire">Médecine Vétérinaire</option>
          </select>
        </div>
